...
const Color primary =Color(0xff505ADF);
const Color secondary = Color(0xff34CC99);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff505ADF);
const Color grad2Color = Color(0xff505ADF);
